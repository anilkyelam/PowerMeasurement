...
spark-submit --class PowerMeasurements.${SCALA_CLASS_NAME} \
        --num-executors 8 --executor-cores 40 --executor-memory 55g --driver-cores 5 --driver-memory 5g  \
        "${SRC_DIR_FULL_PATH}/target/scala-2.11/sparksort_2.11-0.1.jar" yarn "/user/ayelam/sort_inputs/${SIZE_IN_MB}mb" \
