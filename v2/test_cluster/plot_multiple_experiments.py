...
class ExperimentSetupType:

    def __init__(self, id=None, sort_type=None, hdfs_cached=None, replicas=None, page_cache_cleared=None):
        pass
...
experiment_run_times_to_types = {
    '01. Sort=Legacy,   Caching=No,  Replicas=3, Trash=Yes':  ['2018-11-29 00:00:00', '2018-12-01 00:00:00'],
    '02. Sort=NoOutput, Caching=No,  Replicas=3, Trash=NA ': ['2018-12-06 00:00:00', '2018-12-08 00:00:00'],
    '03. Sort=NoOutput, Caching=Yes, Replicas=3, Trash=NA ': ['2018-12-10 22:00:00', '2018-12-11 14:00:00'],
    '04. Sort=NoOutput, Caching=Yes, Replicas=1, Trash=NA ': ['2018-12-21 00:00:00', '2018-12-22 00:00:00'],
    '05. Sort=Legacy,   Caching=No,  Replicas=1, Trash=No ': ['2019-01-15 11:00:00', '2019-01-17 15:00:00'],
    '06. Sort=NoOut,hdfsCach=N,Rep=1': ['2019-01-17 20:00:00', '2019-01-18 13:00:00'],
    '07. Sort=NoOut,hdfsCach=Y,Rep=1': ['2019-01-18 14:00:00', '2019-01-20 00:00:00'],
    '08. Sort=Legacy,   Caching=no,  Replicas=3, Trash=No ': ['2019-01-20 23:00:00', '2019-01-22 12:00:00'],
    '09. Sort=NoOut,hdfsCach=N,Rep=1,PgCach=N': ['2019-01-22 21:00:00', '2019-01-24 00:00:00'],
    '10. Sort=NoOut,hdfsCach=N,Rep=1,PgCach=N,DataPl=R': ['2019-01-24 14:00:00', '2019-01-24 18:00:00'],
    '11. Sort=NoOut,hdfsCach=N,Rep=1,PgCach=N,DataPl=R': ['2019-01-25 22:00:00', '2019-01-26 15:00:00'],
    '12. Sort=NoOut,hdfsCach=Y,Rep=1,PgCach=N,DataPl=R': ['2019-01-26 16:00:00', '2019-01-28 05:00:00'],
    '13. Sort=NoOut,hdfsCach=N,Rep=1,PgCach=N,DataPl=R,10GB': ['2019-01-28 18:00:00', '2019-01-29 00:00:00'],
}
...
setup_types_filter = [
    ...
    # '04. Sort=NoOutput, Caching=Yes, Replicas=1, Trash=NA ',
    # '06. Sort=NoOut,hdfsCach=N,Rep=1',
