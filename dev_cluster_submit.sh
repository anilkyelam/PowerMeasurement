...
nohup python3 meter_reading.py ${unixstamp} ${DURATION} 2>&1 &
fi 
...
/user/shw328/${SIZE}gb.input /user/shw328/${SIZE}gb_output /user/shw328/taskstats_${unixstamp} > spark_${SIZE}gb_${unixstamp}.log 2>&1 &
fi
